...
try{
 ...
 if(environment==='staging'){
  command(['wait','--fn',"document.querySelector('.booking-times')?.getAttribute('aria-busy')==='false' && Boolean(document.querySelector('.booking-slot-grid button'))"]);command(['scrollintoview','.booking-slot-grid button:first-child']);command(['click','.booking-slot-grid button:first-child']);command(['wait','--fn',"document.querySelector('.booking-bottom .booking-primary')?.disabled===false"]);command(['scrollintoview','.booking-bottom .booking-primary']);command(['click','.booking-bottom .booking-primary']);command(['wait','--fn',"Boolean(document.querySelector('.booking-form input[name=name]'))"]);
  command(['fill','.booking-form input[name=name]','Release Test']);command(['fill','.booking-form input[name=email]','release-test@example.com']);command(['check','.booking-form input[name=consent]']);command(['scrollintoview','.booking-form .booking-primary']);command(['click','.booking-form .booking-primary']);command(['wait','--fn',"Boolean(document.querySelector('.booking-success'))"]);
