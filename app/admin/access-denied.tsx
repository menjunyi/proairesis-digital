...
export function AdminAccessDenied() {
  return (
    <main className="grid min-h-screen place-items-center bg-[#fbf4e8] px-5 text-[#062f3b]">
      <section className="w-full max-w-lg rounded-[2rem] border border-[#062f3b]/10 bg-[#fffaf1] p-8 text-center shadow-[0_24px_70px_rgba(23,60,62,0.12)] sm:p-10">
        <span className="mx-auto grid size-16 place-items-center rounded-2xl bg-[#ffe5dc] text-[#b83f28]">
          <ShieldAlert className="size-8" />
        </span>
        <p className="mt-6 text-xs font-black uppercase tracking-[0.15em] text-[#c34527]">Protected workspace</p>
        ...
        <div className="mt-7 flex flex-col justify-center gap-2 sm:flex-row">
          <Link href="/" className="inline-flex h-10 items-center justify-center gap-2 rounded-xl border border-[#062f3b]/15 bg-white px-4 text-sm font-bold">
            <ArrowLeft className="size-4" /> Back to RoleClue
          </Link>
          <a href={chatGPTSignOutPath('/')} target="_top" className="inline-flex h-10 items-center justify-center rounded-xl bg-[#062f3b] px-4 text-sm font-bold text-white">
            Use another account
          </a>
        </div>
      </section>
